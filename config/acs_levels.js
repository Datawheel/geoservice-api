export const levels = {
  shapes: {
    ...
    "tract": {"schema": "shapes2017", "table": "tracts", "id": "geoid", "parent": "county", "columns": ["name", "geoid"], "nameColumn": "namelsad", "srid": 4269},
    "msa": {"schema": "shapes2017", "table": "msas", "id": "geoid", "parent": "state", "columns": ["name", "geoid"], "srid": 4269},
    "puma": {"schema": "shapes2017", "table": "pumas", "id": "geoid", "parent": "state", "columns": ["name", "geoid"], "srid": 4269}
  },
  points: {
    "university": {
      "schema": "ipeds_geo",
